...
process.slimmedJetsSmeared = cms.EDProducer('SmearedPATJetProducer',
        ...
        resolutionFile = cms.FileInPath('JetMETCorrections/JMEReferenceSample/data/Summer15_25nsV6_MC_PtResolution_AK4PFchs.txt'),
        scaleFactorFile = cms.FileInPath('JetMETCorrections/JMEReferenceSample/data/Summer15_25nsV6_MC_SF_AK4PFchs.txt'),
...
process.produceTable = cms.EDAnalyzer('JMEReferenceSampleAnalyzer',

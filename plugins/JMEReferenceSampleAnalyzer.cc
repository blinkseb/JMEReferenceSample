// -*- C++ -*-
//
// Package:    JetMETCorrections/JMEReferenceSampleAnalyzer
// Class:      JMEReferenceSampleAnalyzer
// 
/**\class JMEReferenceSampleAnalyzer JMEReferenceSampleAnalyzer.cc JetMETCorrections/JMEReferenceSampleAnalyzer/plugins/JMEReferenceSampleAnalyzer.cc
...
class JMEReferenceSampleAnalyzer : public edm::one::EDAnalyzer<>  {
   public:
      explicit JMEReferenceSampleAnalyzer(const edm::ParameterSet&);
      ~JMEReferenceSampleAnalyzer();
...
//
JMEReferenceSampleAnalyzer::JMEReferenceSampleAnalyzer(const edm::ParameterSet& iConfig)
{
...
JMEReferenceSampleAnalyzer::~JMEReferenceSampleAnalyzer()
{
...
void
JMEReferenceSampleAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void 
JMEReferenceSampleAnalyzer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
JMEReferenceSampleAnalyzer::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
JMEReferenceSampleAnalyzer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(JMEReferenceSampleAnalyzer);
